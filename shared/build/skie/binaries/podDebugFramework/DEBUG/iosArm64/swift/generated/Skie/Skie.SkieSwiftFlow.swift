...
public final class SkieSwiftFlow<T> : MultiPlatformLibrary.SkieSwiftFlowProtocol,
    ...
    public static func _forceBridgeFromObjectiveC(_ source: MultiPlatformLibrary.SkieKotlinFlow<Swift.AnyObject>, result: inout MultiPlatformLibrary.SkieSwiftFlow<T>?) -> Swift.Void {
    ...
    public func _bridgeToObjectiveC() -> MultiPlatformLibrary.SkieKotlinFlow<Swift.AnyObject> {
        return MultiPlatformLibrary.SkieKotlinFlow(delegate)
    }

    private static func fromObjectiveC(_ source: MultiPlatformLibrary.SkieKotlinFlow<Swift.AnyObject>?) -> Self {
        guard let source = source else {
            fatalError("Couldn't map value of \(Swift.String(describing: source)) to MultiPlatformLibrary.SkieSwiftFlow")
        }
